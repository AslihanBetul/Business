...
public class DeclarationController {
    ...
    public ResponseEntity<ResponseDTO<Declaration>> createForIncomeTax(DeclarationSaveRequestDTO dto) {
    ...
    public ResponseEntity<ResponseDTO<Declaration>> createForVat(DeclarationSaveRequestDTO dto) {
        return ResponseEntity.ok(ResponseDTO
                .<Declaration>builder()
    ...
    public ResponseEntity<ResponseDTO<Declaration>> createForCorporateTax(DeclarationSaveRequestDTO dto) {
        return ResponseEntity.ok(ResponseDTO
                .<Declaration>builder()
