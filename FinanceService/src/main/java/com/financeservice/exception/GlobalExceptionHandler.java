...
import static com.financeservice.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ResponseDTO> handlerSatisException(FinanceServiceException financeServiceExceptionException){
        return  new ResponseEntity<>(createMessage(financeServiceExceptionException.getErrorType(),financeServiceExceptionException), financeServiceExceptionException.getErrorType().getHttpStatus());
    }
